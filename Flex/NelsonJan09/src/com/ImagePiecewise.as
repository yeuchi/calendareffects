		...
		public function reset():Boolean
		{
			...
			for ( var y:int=0; y<_yPieces; y++) {
				for ( var x:int=0; x<_xPieces; x ++ ) {
					...
					var fxRotate:FxRotate3D = new FxRotate3D(uic);
					fxRotate.xFrom = Math.random() * 360;
					fxRotate.yFrom = Math.random() * 360;
					fxRotate.zFrom = Math.random() * 360;
					fxRotate.xTo = 0;
					fxRotate.yTo = 0;
					fxRotate.zTo = 0;
					fxRotate.duration = _duration;
